...
const handleUpdateAndNavigate = async (data) => {
  ...
  const stats = {
    ...
    retard: reservations?.filter(r => r.status === 'retard').length || 0
  };
        ...
        <div className="admin-smaiti-page">
          <div className="smaiti-topbar">
            <div className="smaiti-logo-area">
              ...
              <span className="smaiti-flotte">Réservations</span>
            </div>
          ...
          <div className="stats-grid">
            <div className="stat-card">
              <div><p className="stat-label">Total Réservations</p><p className="stat-number">{stats.total}</p></div>
              <Calendar size={28} className="stat-icon" />
            </div>
            <div className="stat-card">
              <div><p className="stat-label">Confirmées</p><p className="stat-number" style={{ color: '#16a34a' }}>{stats.confirmed}</p></div>
              <CheckCircle2 size={28} className="stat-icon" style={{ color: '#16a34a' }} />
            </div>
            <div className="stat-card">
              <div><p className="stat-label">Terminées</p><p className="stat-number" style={{ color: '#0d4734' }}>{stats.completed}</p></div>
              <CheckCircle size={28} className="stat-icon" style={{ color: '#0d4734' }} />
            </div>
            <div className="stat-card">
              <div><p className="stat-label">En retard</p><p className="stat-number" style={{ color: '#dc2626' }}>{stats.retard}</p></div>
              <AlertTriangle size={28} className="stat-icon" style={{ color: '#dc2626' }} />
            </div>
          </div>

          <div className="smaiti-actions-wrapper">
            <span className="smaiti-count">{filteredReservations.length} réservation(s) (hors en attente, annulé, contacté)</span>
...
<td>
  ...
  .padded-input { padding-left: 32px; }
